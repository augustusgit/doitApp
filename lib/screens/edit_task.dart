...
class _EditTaskState extends State<EditTask> {
  ...
  void initState() {
    ...
    endToCont.text = "27-3-2022";descCont.text = "Lorem ipsum dolor sit amet, conse jose  adipiscing elit. Vestibulum semper  llmauris as lacus, turpis  Lorem ipsum dolor sit amet, conse ";
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: doItAppBar(context, "Do It", showAction: true, showBack: true, showPopMenu: true),
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      doItSubmitButton(context, () => {}, "Add Task" ),
                      SizedBox(
                        height: screenHeight * 0.03,
                      ),
                    ],
